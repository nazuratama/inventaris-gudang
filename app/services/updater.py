...
class UpdateManager:
    ...
    def status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "latest": latest,
            "update_available": bool(self._latest and self._latest.get("update_available")),
    ...
    def check(self) -> dict[str, Any]:
        ...
        if not isinstance(release, dict):
            raise AppError("UPDATE_CHECK_FAILED", "Respons GitHub tidak valid.", status_code=502)
        ...
        self._latest = {
            ...
            "update_available": bool(version and _version_tuple(version) > _version_tuple(__version__)),
    ...
    def stage(self) -> dict[str, Any]:
        ...
        pending_temp.write_text(json.dumps(pending, ensure_ascii=False, indent=2), encoding="utf-8")
